 ...
 * Text Domain: elementor-pro
 GitHub Plugin URI: handreyson/Flixpage-app/blob/master/elementor-pro.zip

GitHub Plugin URI: https://github.com/handreyson/Flixpage-app/blob/master/elementor-pro.zip
...
define( 'ELEMENTOR_PRO_VERSION', '2.1.4' );
